      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <ul class="nav">
          ...
          <div class="collapse" id="pembelian">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item">
                <a class="nav-link" href="#">Pengajuan Pembelian</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Daftar Supplier</a>
              </li>
            </ul>
          </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/changepw.php"> Change Password</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
