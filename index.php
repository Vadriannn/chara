    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <ul class="nav">
          ...
          <li class = "nav-item">
            <a class="nav-link" href="pages/admin/employee.php">
          ...
          <div class="collapse" id="stok">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item">
                <a class="nav-link" href="pages/admin/bahanbaku.php">Bahan Baku</a>
              </li>
              
              <li class="nav-item">
                <a class="nav-link" href="pages/admin/produk.php">Produk</a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="pages/admin/resep.php">Resep</a>
              </li>
            </ul>
          </div>
          </li>
          ...
          <div class="collapse" id="laporan">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item">
                <a class="nav-link" href="pages/admin/laporanpenjualan.php">Laporan Penjualan</a>
              </li>
              
              <li class="nav-item">
                <a class="nav-link" href="pages/admin/laporankeuangan.php">Laporan Keuangan</a>
              </li>

              <li class="nav-item">
                <a class="nav-link" href="pages/admin/aruskas.php">Arus Kas</a>
              </li>

              <li class="nav-item">
                <a class="nav-link" href="pages/admin/labarugi.php">Laba Rugi</a>
              </li>
            </ul>
          </div>
          </li>
          ...
          <?php if ($_SESSION['role'] == 'Gudang' or $_SESSION['role'] == 'Admin'): ?>
           <!-- SIDEBAR MODUL GUDANG  -->
            ...
            <li class = "nav-item">
              <a class="nav-link" href="pages/gudang/bahanbaku.php">
                <i class="typcn typcn-th-large menu-icon"></i>
                <span class="menu-title"> Bahan Baku</span>
              </a>
            </li>
            <li class = "nav-item">
              <a class="nav-link" href="pages/gudang/barangmasuk.php">
                <i class="typcn typcn-arrow-down menu-icon"></i>
                <span class="menu-title"> Barang Masuk </span>
              </a>
            </li>
            <li class = "nav-item">
              <a class="nav-link" href="pages/gudang/barangkeluar.php">
                <i class="typcn typcn-arrow-up menu-icon"></i>
                <span class="menu-title"> Barang Keluar</span>
              </a>
            </li>
            <li class = "nav-item">
              <a class="nav-link" href="pages/gudang/purchaserequest.php">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/settings/ubahpassword.php">
                ...
                <div class="card">
                    <div class="card-body text-center">
                      ...
                      <h5 class="text-muted mb-4">
                          Anda login sebagai <b><?php echo $_SESSION['role']; ?></b>
                      </h5>

                      <p class="mb-0">
                          Selamat datang di Sistem Informasi CHARA.
                          Gunakan menu di sebelah kiri untuk mengakses fitur yang tersedia sesuai dengan hak akses Anda.
                      </p>
                  </div>
              </div>
          </div>
